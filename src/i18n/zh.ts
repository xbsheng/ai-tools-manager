...
export const zh: Record<TranslationKey, string> = {
  ...
  noSkillsFound: "未找到技能",
  noSkillsHint: "点击「添加技能」创建你的第一个技能",
  addSkill: "添加技能",
  deleteSkill: "删除技能",
  editSkill: "编辑技能",
  copySkillContent: "复制内容",
  readOnlySkill: "只读（包含辅助文件）",
  userInvokable: "用户可调用",
  addNewSkill: "添加技能",
  skillName: "技能名称",
  skillNamePlaceholder: "my-skill",
  skillDescription: "描述",
  skillDescriptionPlaceholder: "一句话描述...",
  skillUserInvokable: "用户可调用",
  skillUserInvokableHint: "可以被用户直接调用",
  skillContent: "指令（Markdown）",
  skillContentPlaceholder: "# 技能指令\\n\\n描述这个技能的功能...",
  skillArguments: "参数",
  addArgument: "添加参数",
  argName: "名称",
  argDescription: "描述",
  argRequired: "必填",
  errorSkillNameRequired: "技能名称为必填项",
  errorSkillNameInvalid: "名称只能包含字母、数字和连字符",
  errorSkillContentRequired: "技能内容为必填项",
