      ...
      <div className="bg-bg-card border border-border rounded-xl p-6">
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-lg border transition-all duration-200 ${
                      active
                        ? "border-accent/40 bg-accent/10 text-accent shadow-[0_0_12px_rgba(77,120,204,0.08)]"
        ...
        <div className="mt-6 flex justify-center">
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 rounded-lg bg-accent text-white hover:bg-accent-hover active:scale-[0.97] transition-all duration-200 disabled:opacity-40 disabled:active:scale-100 shadow-[0_0_0_1px_rgba(77,120,204,0.5),0_2px_8px_rgba(77,120,204,0.25)]"
          >
